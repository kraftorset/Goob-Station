...
/// </summary>
public sealed partial class MonolithNightVisionOverlay : Overlay
{
    [Dependency] private IPrototypeManager _prototypeManager = default!;

    private static readonly ProtoId<ShaderPrototype> Shader = "MonolithNightVision";
    ...
    public MonolithNightVisionOverlay()
    {
